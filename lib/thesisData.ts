...
export const MARKET_TIERS = [
  {
    ...
    description: 'All acute care hospitals in the United States — every facility capable of autonomous delivery operations across pharmacy, labs, food, and EVS workflows.',
    hospitals: 5100,
    avg_beds: 200,
    deploy_mult: 1.15,
    deployments: 5865,
    robots_per_deploy: 11.2,
    total_robots: 65688,
    color: '#6366f1',
    source: 'AHA Fast Facts 2026; CMS Hospital General Information',
  },
  {
    tier: 'SAM',
